<section style="{{ $styles }}" class="{{ $classes }} s-blog6 @if(isset($block['className'])) {{ $block['className'] }} @endif">
  <div class="container">
    <div class="filters">
      ...
      <div class="posts">
        @foreach($posts as $post)
          <div class="post-6">
            ...
            <a class="post-6__category" href="{!! get_term_link(get_the_terms($post->ID, 'category')[0]->term_id) !!}">
