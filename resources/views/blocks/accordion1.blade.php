<section style="{{ $styles }}" class="{{ $classes }} s-accordion1  @if(isset($block['className'])) {{ $block['className'] }} @endif">
  <div class="container">
    ...
    <div class="accordions">
      ...
      <details class="c-accordion" accordion>
        ...
        <section class="c-accordion-1-content-{{ $key }} c-accordion-content">
