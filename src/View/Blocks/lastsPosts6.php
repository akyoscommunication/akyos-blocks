...
class lastsPosts6 extends Block
{
    public $posts;
    public $taxonomy;
    ...
    protected static function block(): GutenbergBlock
    {
        return (new GutenbergBlock())
            ->setName("lasts-posts6")
            ->setTitle("DERNIERS POSTS | 6")
            ->setCategory("post")
            ->setIcon("admin-post")
            ->setPreviewImage(get_template_directory_uri() . '/vendor/akyos/akyos-blocks/resources/assets/previews/lastsposts6.jpg');
    }
    ...
    {
        if (file_exists(get_template_directory() . '/resources/views/blocks/lasts-posts6.blade.php')) {
            return view('blocks.lasts-posts6');
        } else {
            return view('akyos-blocks::blocks.lasts-posts6');
        }
    }
}
