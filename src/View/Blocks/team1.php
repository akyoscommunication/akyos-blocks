...
class team1 extends Block
{
    ...
    protected static function block(): GutenbergBlock
    {
        return (new GutenbergBlock())
            ...
            ->setCategory("team")
            ->setIcon("groups")
            ->setPreviewImage(get_template_directory_uri() . '/vendor/akyos/akyos-blocks/resources/assets/previews/team1.jpg');
    }
    ...
    {
        if (file_exists(get_template_directory() . '/resources/views/blocks/team1.blade.php')) {
            return view('blocks.team1');
        } else {
            return view('akyos-blocks::blocks.team1');
        }
    }
}
