...
class team5 extends Block
{
    ...
    protected static function block(): GutenbergBlock
    {
        return (new GutenbergBlock())
            ...
            ->setCategory("team")
            ->setIcon("groups")
            ->setPreviewImage(get_template_directory_uri() . '/vendor/akyos/akyos-blocks/resources/assets/previews/team5.jpg');
    }
    ...
    {
        if (file_exists(get_template_directory() . '/resources/views/blocks/team5.blade.php')) {
            return view('blocks.team5');
        } else {
            return view('akyos-blocks::blocks.team5');
        }
    }
}
