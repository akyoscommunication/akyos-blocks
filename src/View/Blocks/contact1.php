...
class contact1 extends Block
{
    ...
    protected static function block(): GutenbergBlock
    {
        return (new GutenbergBlock())
            ...
            ->setCategory("form")
            ->setIcon("email")
            ->setPreviewImage(get_template_directory_uri() . '/vendor/akyos/akyos-blocks/resources/assets/previews/contact1.jpg');
    }
    ...
    {
        if (file_exists(get_template_directory() . '/resources/views/blocks/contact1.blade.php')) {
