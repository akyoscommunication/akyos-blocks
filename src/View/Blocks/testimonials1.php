...
class testimonials1 extends Block
{
    ...
    protected static function block(): GutenbergBlock
    {
        return (new GutenbergBlock())
            ->setName("testimonials1")
            ->setTitle("TEMOIGNAGES | 1")
            ->setCategory("testimonial")
            ->setIcon("testimonial")
            ->setPreviewImage(get_template_directory_uri() . '/vendor/akyos/akyos-blocks/resources/assets/previews/testimonials1.jpg');
    }
