...
class team2 extends Block
{
    ...
    protected static function block(): GutenbergBlock
    {
        return (new GutenbergBlock())
            ...
            ->setCategory("team")
            ->setIcon("groups")
            ->setPreviewImage(get_template_directory_uri() . '/vendor/akyos/akyos-blocks/resources/assets/previews/team2.jpg');
    }
    ...
    {
        if (file_exists(get_template_directory() . '/resources/views/blocks/team2.blade.php')) {
            return view('blocks.team2');
        } else {
            return view('akyos-blocks::blocks.team2');
        }
    }
}
