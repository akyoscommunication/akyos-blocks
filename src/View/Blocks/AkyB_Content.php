...
use Akyos\Blocks\Acf\Fields\AkyB_Content12;
...
use Akyos\Blocks\Acf\Fields\AkyB_Content16;
...
class AkyB_Content extends Block
{
    ...
    protected static function fields(): array
    {
        return [
            ...
            AkyB_Content12::make("Contenu 12", "content12")
                ->layout('block')
                ->conditionalLogic([
                    ConditionalLogic::where('style', '==', '12')
                ]),
            ...
            AkyB_Content16::make("Contenu 16", "content16")
                ->layout('block')
                ->conditionalLogic([
                    ConditionalLogic::where('style', '==', '16')
                ]),
        ];
    }
