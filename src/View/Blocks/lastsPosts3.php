...
class lastsPosts3 extends Block
{
    ...
    protected static function block(): GutenbergBlock
    {
        return (new GutenbergBlock())
            ...
            ->setCategory("post")
            ->setIcon("admin-post")
            ->setPreviewImage(get_template_directory_uri() . '/vendor/akyos/akyos-blocks/resources/assets/previews/lastsposts3.jpg');
    }
    ...
    {
        if (file_exists(get_template_directory() . '/resources/views/blocks/lasts-posts3.blade.php')) {
            return view('blocks.lasts-posts3');
        } else {
