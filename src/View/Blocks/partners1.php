...
class partners1 extends Block
{
    ...
    protected static function block(): GutenbergBlock
    {
        return (new GutenbergBlock())
            ...
            ->setCategory("partner")
            ->setIcon("groups")
            ->setPreviewImage(get_template_directory_uri() . '/vendor/akyos/akyos-blocks/resources/assets/previews/partners1.jpg')
        ;
    }
    ...
    {
        if (file_exists(get_template_directory() . '/resources/views/blocks/partners1.blade.php')) {
