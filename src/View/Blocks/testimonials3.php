...
class testimonials3 extends Block
{
    ...
    protected static function block(): GutenbergBlock
    {
        return (new GutenbergBlock())
            ->setName("testimonials3")
            ->setTitle("TEMOIGNAGES | 3")
            ->setCategory("testimonial")
            ->setIcon("testimonial")
            ->setPreviewImage(get_template_directory_uri() . '/vendor/akyos/akyos-blocks/resources/assets/previews/testimonials3.jpg');
    }
    ...
    {
        if (file_exists(get_template_directory() . '/resources/views/blocks/testimonials3.blade.php')) {
            return view('blocks.testimonials3');
        } else {
            return view('akyos-blocks::blocks.testimonials3');
        }
    }
}
