...
class testimonials4 extends Block
{
    ...
    {
        if (file_exists(get_template_directory() . '/resources/views/blocks/testimonials4.blade.php')) {
            return view('blocks.testimonials4');
        } else {
            return view('akyos-blocks::blocks.testimonials4');
        }
    }
}
