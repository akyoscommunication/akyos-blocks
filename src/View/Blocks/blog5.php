...
class blog5 extends Block
{
    ...
    protected static function block(): GutenbergBlock
    {
        return (new GutenbergBlock())
            ...
            ->setPreviewImage(get_template_directory_uri() . '/vendor/akyos/akyos-blocks/resources/assets/previews/blog5.jpg');
    }
    ...
    {
        if (file_exists(get_template_directory() . '/resources/views/blocks/blog5.blade.php')) {
            return view('blocks.blog5');
        } else {
            return view('akyos-blocks::blocks.blog5');
        }
    }
}
