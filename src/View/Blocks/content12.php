...
class content12 extends Block
{
    ...
    protected static function block(): GutenbergBlock
    {
        return (new GutenbergBlock())
            ...
            ->setCategory("content")
            ->setIcon("align-left")
            ->setPreviewImage(get_template_directory_uri() . '/vendor/akyos/akyos-blocks/resources/assets/previews/content12.jpg');
    }
    ...
    {
        if (file_exists(get_template_directory() . '/resources/views/blocks/content12.blade.php')) {
            return view('blocks.content12');
        } else {
