...
var Filters = /*#__PURE__*/function () {
  function Filters() {
    ...
    document.querySelectorAll('*[data-filters]').forEach(function (container) {
      var endpoint = document.querySelector(container.dataset.filters);
      if (endpoint) {
        var isMultiple = container.getAttribute('data-filters-multiple') === 'true';
        var filters = container.querySelectorAll('*[data-filter]');
        var filtereds = endpoint.querySelectorAll('*[data-filtered]');
        filters.forEach(function (filter) {
          filter.addEventListener('click', function (e) {
            e.preventDefault();
            _this.filter(filtereds, filters, filter);
          });
        });
        _this.filter(filtereds, filters, filters[0]);
      }
    });
  }
  return _createClass(Filters, [{
    key: "reset",
    value: function reset(filtereds, filters) {
      filters.forEach(function (filter) {
    ...
    key: "showAll",
    value: function showAll(filtereds) {
      filtereds.forEach(function (filtered) {
    ...
    key: "filter",
    value: function filter(filtereds, filters, _filter) {
      var filterValue = _filter.dataset.filter || _filter;
      ...
      filtereds.forEach(function (filtered) {
        var filters_availables = filtered.dataset.filtered.split('|');
...
var Header = /*#__PURE__*/function () {
  ...
  return _createClass(Header, [{
    ...
    value: function burger() {
      ...
      if (this.header) {
        var nav = document.querySelector('.header-nav__burger');
        var _burger = document.querySelector('#burger');
        var menu = document.querySelector('.header-nav__nav');
        if (_burger) {
          _burger.addEventListener('click', function (evt) {
            evt.preventDefault();
            _burger.classList.toggle('active');
            nav.classList.toggle('expanded');
          });
          window.addEventListener('resize', function (evt) {
            var breakpoint = _burger.getAttribute('data-breakpoint');
            if (window.matchMedia('(max-width: ' + breakpoint + 'px)').matches) {
              menu.style.display = 'none';
              _burger.classList.remove('hidden');
              _burger.classList.add('show');
            } else {
              menu.style.display = 'block';
              _burger.classList.remove('show');
              _burger.classList.add('hidden');
            }
          });
        }
        var burgerSubmenus = document.querySelectorAll('.header-nav__burger .menu .menu-item-has-children');
        ...
        burgerSubmenus.forEach(function (t) {
          ...
          t.addEventListener('click', function (e) {
            var submenus = document.querySelectorAll('.header-nav__burger .menu > .menu-item-has-children');
        ...
        burgerSubSubmenus.forEach(function (tt) {
          var trigger = tt.querySelectorAll('a')[0].offsetHeight;
          var height = tt.querySelector('.sub-menu').offsetHeight + trigger;
          tt.style.setProperty('--max-height', height + 'px');
          tt.style.setProperty('--init-height', trigger + 'px');
          tt.addEventListener('click', function (e) {
            e.stopPropagation();
            var subsubmenus = document.querySelectorAll('.sub-menu > .menu-item-has-children');
            subsubmenus.forEach(function (ss) {
    ...
    value: function scrollHandler() {
      ...
      document.addEventListener('scroll', function () {
        ...
        if (height > 0 && !_this.header.classList.contains('scrolled')) {
          _this.header.classList.toggle('scrolled');
        }
        if (height === 0 && _this.header.classList.contains('scrolled')) {
          _this.header.classList.toggle('scrolled');
        }
    ...
    value: function search() {
      var search = document.querySelector('.header-actions-search');
...
var Slider = /*#__PURE__*/function () {
  ...
  return _createClass(Slider, [{
    ...
    value: function registerSlider(slider) {
      ...
      if (sco === '1') {
        modules.push(swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Scrollbar);
        scrollbar = {
      ...
      if (nav === 'arrow') {
        modules.push(swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation);
        navigation = {
      ...
      if (autoplayAttr) {
        modules.push(swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay);
        autoplayOptions = {
      ...
      if (paginationAttr === '1') {
        // Nouvelle logique
        pagination = {
          el: ".swiper-pagination-".concat(slider_id),
          clickable: true
        };
        modules.push(swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination);
      }
      var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.' + name, {
        modules: modules,
      ...
      var arraySlideIndex = [2];
      var currentIndex = swiper.activeIndex;
      var slides = document.querySelectorAll('.swiper-slide');
      swiper.on('slideChange', function (e) {
        slides.forEach(function (item) {
          return item.classList.remove('third-slide-before');
        });
...
/* harmony import */ var _components_Filters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/Filters */ "./resources/assets/js/components/Filters.js");
/* harmony import */ var _components_Header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/Header */ "./resources/assets/js/components/Header.js");



window.onload = function () {
  new _components_Slider__WEBPACK_IMPORTED_MODULE_0__.Slider();
  new _components_Filters__WEBPACK_IMPORTED_MODULE_1__.Filters();
  new _components_Header__WEBPACK_IMPORTED_MODULE_2__.Header();
};
...
throw new Error("Module build failed (from ./node_modules/mini-css-extract-plugin/dist/loader.js):\nModuleBuildError: Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: The target selector was not found.\nUse \"@extend %fs-26 !optional\" to avoid this error.\n  ╷\n9 │         @extend %fs-26;\n  │         ^^^^^^^^^^^^^^\n  ╵\n  resources/assets/css/utils/blocks/content/_content-14.scss 9:9  root stylesheet\n    at processResult (/Users/akyos/Documents/sites/akyosblock/bedrock/web/app/themes/akyos-sage/vendor/akyoscommunication/akyos-blocks/node_modules/webpack/lib/NormalModule.js:890:19)\n    at /Users/akyos/Documents/sites/akyosblock/bedrock/web/app/themes/akyos-sage/vendor/akyoscommunication/akyos-blocks/node_modules/webpack/lib/NormalModule.js:1036:5\n    at /Users/akyos/Documents/sites/akyosblock/bedrock/web/app/themes/akyos-sage/vendor/akyoscommunication/akyos-blocks/node_modules/loader-runner/lib/LoaderRunner.js:400:11\n    at /Users/akyos/Documents/sites/akyosblock/bedrock/web/app/themes/akyos-sage/vendor/akyoscommunication/akyos-blocks/node_modules/loader-runner/lib/LoaderRunner.js:252:18\n    at context.callback (/Users/akyos/Documents/sites/akyosblock/bedrock/web/app/themes/akyos-sage/vendor/akyoscommunication/akyos-blocks/node_modules/loader-runner/lib/LoaderRunner.js:124:13)\n    at Object.loader (/Users/akyos/Documents/sites/akyosblock/bedrock/web/app/themes/akyos-sage/vendor/akyoscommunication/akyos-blocks/node_modules/sass-loader/dist/index.js:69:5)");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/assets/css/main.scss");
/******/ 	
/******/ })()
;